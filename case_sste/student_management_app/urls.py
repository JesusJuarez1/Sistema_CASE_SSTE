...
urlpatterns = [
    ...
    path('editar_baja/<baja_id>/', HodViews.editarBaja, name="editar_baja"),
    path('reportes_alumnos/', HodViews.reporte_alumnos, name="reportes_alumnos"),
    path('add_programa/', HodViews.add_programa, name="add_programa"),
    path('add_programa_save/', HodViews.add_programa_save,
         name="add_programa_save"),
    path('manage_programa/', HodViews.manage_programa, name="manage_programa"),
    path('edit_programa/<programa_id>/',
         HodViews.edit_programa, name="edit_programa"),
    path('edit_programa_save/', HodViews.edit_programa_save,
         name="edit_programa_save"),
    path('delete_programa/<programa_id>/',
         HodViews.delete_programa, name="delete_programa"),
    path('baja_alumno_save/reporte_baja_pdf/<baja_id>/',
         HodViews.reporte_baja_pdf, name="reporte_baja_pdf"),


    # bajas de alumnos
    path('buscar_estudiante/', HodViews.buscar_estudiante,
         name="buscar_estudiante"),
    path('baja_alumno_save/', HodViews.bajasAlumnosSave, name="baja_alumno_save"),
    path('eliminar_baja/<baja_id>/', HodViews.eliminar_baja, name="eliminar_baja"),


    # reportes
    path('exportar_csv_bajas/', HodViews.export_csv_baja_alumnos,
         name='exportar_csv_bajas'),

    # calendario
    path('calendario/', HodViews.calendarioSesiones, name='calendario'),
    ...
    path('form/create/contact', views.contact_form_template,
         name="contact_form_template"),
    path('form/create/feedback', views.customer_feedback_template,
         name="customer_feedback_template"),
    path('form/create/event', views.event_registration_template,
    ...
    path('form/<str:code>/edit_description',
         views.edit_description, name="edit_description"),
    path('form/<str:code>/edit_background_color',
         views.edit_bg_color, name="edit_background_color"),
    path('form/<str:code>/edit_text_color',
         views.edit_text_color, name="edit_text_color"),
    path('form/<str:code>/edit_setting',
         views.edit_setting, name="edit_setting"),
    path('form/<str:code>/delete', views.delete_form, name="delete_form"),
    path('form/<str:code>/edit_question',
    ...
    path('form/<str:code>/remove_choice',
         views.remove_choice, name="remove_choice"),
    path('form/<str:code>/get_choice/<str:question>',
         views.get_choice, name="get_choice"),
    path('form/<str:code>/add_question',
         views.add_question, name="add_question"),
    path('form/<str:code>/delete_question/<str:question>',
    ...
    path('form/<str:code>/response/<str:response_code>',
         views.response, name="response"),
    path('form/<str:code>/response/<str:response_code>/edit',
         views.edit_response, name="edit_response"),
    path('form/<str:code>/responses/delete',
         views.delete_responses, name="delete_responses"),
    path('403', views.FourZeroThree, name="403"),
    path('404', views.FourZeroFour, name="404"),
    path('formularios/', views.misEncuestas, name="formularios"),



    # servicios
    path('servicios', HodViews.mostrarServicios, name='servicios'),
    path('registrar_servicios/', HodViews.registrarServicios,
         name='registrar_servicios'),
    path('editar_servicios/<int:id>',
         HodViews.editarServicio, name='editar_servicios'),
    path('eliminar_servicios/<int:id>',
         HodViews.eliminarServicio, name='eliminar_servicios'),
